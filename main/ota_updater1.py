...
class OTAUpdater:
  ...
  def __init__(self, github_repo, module='', main_dir='main'):
    ...
    self.github_repo = github_repo.rstrip('/').replace('https://github.com/kitsunegeisha/main.git', 'https://api.github.com/repos/kitsunegeisha/main/commits?path=code/ConnectWifi.1.2.py')
